...
class CustomDataset(utils.Dataset):
    ...
    def load_custom(self, dataset_dir, subset):
        ...
        self.add_class("object", 1, "Aggregate Reticulocyte")
        self.add_class("object", 2, "Punctate Reticulocyte")
        self.add_class("object", 3, "Erythrocyte")
        ...
        print("path:",os.path.join(dataset_dir, "ReticulocyteTest.json"))
        annotations = json.load(open(os.path.join(dataset_dir, "ReticulocyteTest.json")))
        ...
        for a in annotations:
            ...
            objects = [s['region_attributes']['Reticulocytes'] for s in a['regions']]
            name_dict = {"Aggregate Reticulocyte": 1,"Punctate Reticulocyte": 2,"Erythrocyte": 3}
            # key = tuple(name_dict)
